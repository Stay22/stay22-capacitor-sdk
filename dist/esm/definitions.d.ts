...
export interface Stay22Plugin {
     ...
     * Capacitor slot.
     */
    isNotificationHandlerInstalled(): Promise<{
        value: boolean;
    }>;
    /**
    ...
    addListener(eventName: 'stay22Event', listenerFunc: (event: Stay22SDKEvent) => void): Promise<PluginListenerHandle>;
